...
// Resolve `@praxis/storage` self-imports and the `@praxis/dsl` dependency to
...
export default defineConfig({
  resolve: {
    alias: {
      '@praxis/storage': fileURLToPath(new URL('./src/index.ts', import.meta.url)),
      '@praxis/dsl': fileURLToPath(new URL('../dsl/src/index.ts', import.meta.url)),
    },
  },
  test: {
