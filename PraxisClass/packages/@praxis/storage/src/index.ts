/**
 * @praxis/storage — the PraxisClass pluggable persistence layer.
 *
 * Dependency arrow (kept acyclic): `@praxis/storage -> @praxis/dsl` only.
...
export type { AssetRef, AssetMeta, BinaryBlob, StorageProvider } from '@praxis/dsl';
