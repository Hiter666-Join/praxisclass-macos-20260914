 ...
 * portable, embedded {@link PraxisDocument} and the per-entity rows a backend
 ...
 */
import { DSL_VERSION, DSL_VERSION_KEY } from '@praxis/dsl';
import type { Stage } from '@praxis/dsl';
import type { PraxisDocument, SceneLike } from './types.js';
...
export function reassembleDocument<TScene extends SceneLike, TStage extends Stage = Stage>(
  ...
  const doc: PraxisDocument<TScene, TStage> = { stage, scenes, dslVersion };
