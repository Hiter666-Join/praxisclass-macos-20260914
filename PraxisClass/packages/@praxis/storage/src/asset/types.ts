...
export class AssetNotFoundError extends Error {
  ...
  constructor(message = '@praxis/storage: no asset is stored under that id') {
    super(message);
...
export class AssetQuotaExceededError extends Error {
  ...
  constructor(message = '@praxis/storage: asset quota exceeded for this principal') {
    super(message);
 ...
 * descriptor.
 */
export const ASSET_DESCRIPTOR_MEDIA_TYPE = 'application/vnd.praxis.asset-descriptor+json';
