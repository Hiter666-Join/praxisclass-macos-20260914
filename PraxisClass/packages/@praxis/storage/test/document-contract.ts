...
import type { Scene } from '@praxis/dsl';
import { DocumentVersionError, type DocumentStore, type PraxisDocument } from '../src/index.js';
...
export function makeDocument(stageId = 'stage-1'): PraxisDocument {
  return {
