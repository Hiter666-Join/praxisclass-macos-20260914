...
import { isWidgetType, normalizeElement } from '@praxis/dsl';
...
export interface SceneContentOptions {
  ...
  /**
   * Natural-language edit instruction for whole-slide regeneration (PraxisClass Editor
 ...
 * owned by the DSL contract — `normalizeElement` from `@praxis/dsl` — rather
...
async function generateSlideContent(
  ...
  // EDIT MODE (PraxisClass Editor agent `regenerate_scene`): when an edit instruction
