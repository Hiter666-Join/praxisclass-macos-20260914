...
import { generateSceneOutlinesFromRequirements } from '@praxis/generation';
import { generateSceneContent } from '@praxis/generation';
import type { SceneOutline, UserRequirements } from '@praxis/generation';
