...
PraxisClass's renderer sends iframe messages using `event.data.type` as the platform message field. Generated HTML must read `event.data.type`; do not invent alternate message fields.
