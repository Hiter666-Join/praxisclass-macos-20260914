...
import type { PPTTableElement, TableCell, TableCellBorder } from '@praxis/dsl';
import { getTableSubThemeColor } from '@praxis/renderer';
import { getTextStyle } from '@praxis/renderer/elements';
