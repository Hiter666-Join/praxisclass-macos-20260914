...
function shortcut(label: string, value: string) {
  return (
    <>
      <span>{label}</span>
      <span className="praxis-editing-ui-context-menu-shortcut">{value}</span>
    </>
  );
}
...
function MenuSubmenu({
  ...
  return (
    <div className="praxis-editing-ui-context-menu-submenu">
      <button type="button" className="praxis-editing-ui-context-menu-item" aria-haspopup="menu">
        <span>{label}</span>
        <span aria-hidden="true">›</span>
      </button>
      <div className="praxis-editing-ui-context-menu-submenu-content" role="menu">
        {children}
      </div>
    </div>
  );
...
export function CanvasContextMenu({
  ...
  return (
    <div
      ...
      className="praxis-editing-ui-context-menu-root"
    ...
    >
      ...
      {isOpen && typeof document !== 'undefined'
        ? createPortal(
            <div
              ref={menuRef}
              className="praxis-editing-ui-root praxis-editing-ui-context-menu"
              role="menu"
              style={{
                ...
                zIndex: 'var(--praxis-editing-ui-z-index, 80)',
              }}
            >
              {menu.kind === 'canvas' ? (
                <>
                  ...
                  <div className="praxis-editing-ui-context-menu-separator" role="separator" />
