...
import type { PPTAudioElement } from '@praxis/dsl';
...
export function AudioToolbarOverlay({
  ...
  return createPortal(
    <div
      className="praxis-editing-ui-root praxis-editing-ui-audio-toolbar-root"
    ...
    >
      <div
        ref={toolbarRef}
        className="praxis-editing-ui-audio-toolbar"
        role="toolbar"
