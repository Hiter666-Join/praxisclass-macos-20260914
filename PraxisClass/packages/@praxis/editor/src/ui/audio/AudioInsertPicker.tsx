...
export function AudioInsertPicker({ labels, onInsert }: AudioInsertPickerProps) {
  ...
  return (
    <div className="praxis-editing-ui-audio-insert-picker">
      <button
        type="button"
        className="praxis-editing-ui-audio-dropzone"
      ...
      />
      <div className="praxis-editing-ui-audio-or">{labels.audioOr}</div>
      <div className="praxis-editing-ui-audio-url-row">
        <input
          type="url"
          value={url}
