...
export function LatexEditorDialog({
  ...
  return (
    <div className="praxis-editing-ui-latex-backdrop" onPointerDown={onClose}>
      <section
        className="praxis-editing-ui-latex-dialog"
        role="dialog"
        aria-modal="true"
        aria-label={labels.dialog}
        onPointerDown={(event) => event.stopPropagation()}
      >
        <div className="praxis-editing-ui-latex-main">
          <div className="praxis-editing-ui-latex-workspace">
            <label className="praxis-editing-ui-latex-source-label" htmlFor="maic-latex-source">
              {labels.source}
            </label>
            <textarea
              ref={sourceRef}
              id="maic-latex-source"
              className="praxis-editing-ui-latex-source"
              value={latex}
              onChange={(event) => setLatex(event.target.value)}
              spellCheck={false}
            />
            <div className="praxis-editing-ui-latex-preview-shell">
              <span className="praxis-editing-ui-latex-preview-label">{labels.preview}</span>
              <div className="praxis-editing-ui-latex-preview" data-testid="latex-editor-preview">
              ...
              <p className="praxis-editing-ui-latex-error" role="status" aria-live="polite">
        ...
        <footer className="praxis-editing-ui-latex-footer">
          <button type="button" className="praxis-editing-ui-latex-cancel" onClick={onClose}>
            {labels.cancel}
          </button>
          <button
            type="button"
            className="praxis-editing-ui-latex-confirm"
            disabled={!canConfirm}
            onClick={confirm}
          >
            {labels.confirm}
