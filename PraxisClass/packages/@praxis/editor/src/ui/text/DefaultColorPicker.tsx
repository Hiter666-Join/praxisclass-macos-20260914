...
export function DefaultColorPicker({
  ...
  return (
    <div className="praxis-editing-ui-color-picker">
      <HexColorPicker color={color} onChange={handleChange} />
      <div className="praxis-editing-ui-color-current-row">
        <div className="praxis-editing-ui-color-current-value">
          <span
            className="praxis-editing-ui-color-current-swatch"
            aria-hidden="true"
            style={{ backgroundColor: color }}
          />
          <span className="praxis-editing-ui-color-current-hex">{color}</span>
        </div>
        {EyeDropper ? (
          <button
            type="button"
            className="praxis-editing-ui-color-eyedropper"
      ...
      <div className="praxis-editing-ui-color-swatches" role="group" aria-label={labels.color}>
        {COMMON_COLOR_SWATCHES.map((swatch) => (
          <button
            key={swatch}
            type="button"
            className="praxis-editing-ui-color-swatch"
            aria-label={swatch}
            onMouseDown={(event) => event.preventDefault()}
