...
export function FontSizeControl({ value, labels, onCommand }: FontSizeControlProps) {
  ...
  return (
    <div className="praxis-editing-ui-font-size-stepper" role="group" aria-label={labels.fontSize}>
      <button
        type="button"
        className="praxis-editing-ui-step-button"
      ...
      <input
        ...
        inputMode="numeric"
        role="spinbutton"
        className="praxis-editing-ui-font-size-input"
