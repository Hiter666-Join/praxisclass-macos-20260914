...
function Divider() {
  return <div className="praxis-editing-ui-divider" aria-hidden="true" />;
}
...
export function TextFormatToolbar({
  ...
  const classes = ['praxis-editing-ui-root', 'praxis-editing-ui-text-toolbar', className]
    .filter(Boolean)
    .join(' ');
  ...
  return (
    <div className={classes} role="toolbar" aria-label={labels.toolbar} data-placement={placement}>
      <div className="praxis-editing-ui-group praxis-editing-ui-font-group">
        <select
          className="praxis-editing-ui-select"
      ...
      <Divider />
      <div className="praxis-editing-ui-group">
        <button
          type="button"
        ...
        <div className="praxis-editing-ui-color-control">
          <button
            ref={colorButtonRef}
            type="button"
