...
export function TableInsertPicker({ onPick, getLabel }: TableInsertPickerProps) {
  ...
  return (
    <div className="praxis-editing-ui-table-picker">
      <div className="praxis-editing-ui-table-grid" role="grid">
          ...
          Array.from({ length: MAX_COLUMNS }, (_, columnIndex) => {
            ...
            return (
              <button
                ...
                className="praxis-editing-ui-table-grid-cell"
              />
            );
          }),
        )}
      </div>
      <div data-testid="table-insert-dimensions" className="praxis-editing-ui-table-dimensions">
