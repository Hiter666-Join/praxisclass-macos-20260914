...
import type { SlideBackground } from '@praxis/dsl';
...
export function BackgroundInsertPicker({
  ...
  return (
    <div className="praxis-editing-ui-background-picker">
      <div className="praxis-editing-ui-background-tabs" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={tab === 'solid'}
          className="praxis-editing-ui-background-tab"
      ...
      {tab === 'solid' ? (
        <label className="praxis-editing-ui-background-color-field">
          <span>{labels.color}</span>
          <span className="praxis-editing-ui-background-color-inputs">
            <input
              type="color"
        ...
        <div className="praxis-editing-ui-background-image-picker">
