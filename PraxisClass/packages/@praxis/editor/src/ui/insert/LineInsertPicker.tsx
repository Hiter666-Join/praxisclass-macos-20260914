...
import type { LinePoint, LineStyleType } from '@praxis/dsl';
...
export function LineInsertPicker({ labels: labelOverrides, onPick }: LineInsertPickerProps) {
  ...
  return (
    <div className="praxis-editing-ui-line-insert-picker" role="group" aria-label={labels.label}>
      {PRESETS.map(({ label, preset }) => (
        <button
          key={label}
          type="button"
          aria-label={labels[label]}
          className="praxis-editing-ui-line-insert-option praxis-editing-ui-tooltip-button"
