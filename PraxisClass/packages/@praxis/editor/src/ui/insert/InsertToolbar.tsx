...
function InsertToolbarButton({
  ...
  return (
    <button
      type="button"
      className="praxis-editing-ui-icon-button praxis-editing-ui-insert-button praxis-editing-ui-tooltip-button"
...
export function InsertToolbar({
  ...
  return (
    <div
      ref={rootRef}
      className={['praxis-editing-ui-root', 'praxis-editing-ui-insert-toolbar', className]
        .filter(Boolean)
        .join(' ')}
      role="toolbar"
      aria-label={label}
    ...
    >
      <div className="praxis-editing-ui-insert-buttons">
        {items.map((item) => (
          <InsertToolbarButton
            key={item.id}
            item={item}
      ...
      {openItem?.renderPopover ? (
        <div
          className="praxis-editing-ui-insert-popover"
          role="dialog"
