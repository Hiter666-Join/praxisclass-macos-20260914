...
import type { PPTVideoElement } from '@praxis/dsl';
...
export function VideoToolbarOverlay({
  ...
  return createPortal(
    <div
      ref={rootRef}
      className="praxis-editing-ui-root praxis-editing-ui-video-toolbar-root"
    ...
    >
      <div
        ref={toolbarRef}
        className="praxis-editing-ui-video-toolbar"
        role="toolbar"
      ...
      >
        {renderPosterPicker ? (
          <button
            type="button"
            className="praxis-editing-ui-icon-button praxis-editing-ui-tooltip-button"
        ...
        {onBringToFront || onSendToBack || onDelete ? (
          <span className="praxis-editing-ui-divider" aria-hidden="true" />
        ) : null}
        {onBringToFront ? (
          <button
            type="button"
        ...
        {onDelete ? (
          <>
            ...
            <button
              type="button"
              className="praxis-editing-ui-icon-button praxis-editing-ui-delete-button praxis-editing-ui-tooltip-button"
      ...
      {showPosterPicker ? (
        <div
          className="praxis-editing-ui-video-poster-popover"
          role="dialog"
          aria-label={labels.poster}
        >
          {renderPosterPicker({
