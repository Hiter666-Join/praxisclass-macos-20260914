...
import { useViewportSize } from '@praxis/renderer';
import { getLineElementPath } from '@praxis/renderer';
...
vi.mock('@praxis/renderer', async (importOriginal) => ({
  ...(await importOriginal<typeof import('@praxis/renderer')>()),
