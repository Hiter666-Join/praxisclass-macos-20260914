...
describe('TextFormatToolbar', () => {
  ...
  it('uses the legacy control order and visual structure', () => {
    ...
    expect(toolbar.classList).toContain('praxis-editing-ui-text-toolbar');
    expect(container.querySelector('.praxis-editing-ui-font-size-stepper')).not.toBeNull();
    expect(container.querySelectorAll('.praxis-editing-ui-divider')).toHaveLength(4);
    expect(
