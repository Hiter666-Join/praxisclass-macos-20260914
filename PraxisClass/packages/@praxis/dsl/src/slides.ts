/**
 * The PraxisClass slide object model — the canonical, dependency-free contract.
 *
 * This file is the single source of truth that supersedes the three copies that
 * had drifted apart before @praxis/dsl existed:
 *   - app:      lib/types/slides.ts
 *   - renderer: packages/@praxis/renderer/src/types/slides.ts
 *   - importer: packages/@praxis/importer/src/openmaic/types/slides.ts
 *
