 ...
 * document to another runtime. `@praxis/renderer` already consumes resolved
 ...
 * future `@praxis/exporter` package can build on the same contract.
 *
 ...
 * CDN on a server — live in `@praxis/storage`, keeping this package
 ...
 * pure package to the DOM lib. Backends in `@praxis/storage` accept a real
