...
Each face below must be cleared for redistribution and attributed here. This file is the
font attribution/clearance record; it is **separate** from the package's own
MIT license metadata, which does not cover the fonts.
