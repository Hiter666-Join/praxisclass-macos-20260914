...
const WB_STYLE = 'bg-accent border-primary/30 text-primary';
const WB_ACCENT = 'bg-primary';
...
const DEFAULT_STYLE = 'bg-muted border-border text-muted-foreground';
  ...
  return (
    ...
    >
      ...
      {isWb && (
        ...
        >
          <PenLine className="w-[7px] h-[7px] text-primary-foreground" strokeWidth={2.5} />
        </span>
      )}
