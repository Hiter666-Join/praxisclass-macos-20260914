...
const PBL_WORKSPACE_THEME = {
  ...
  '--primary': DEFAULT_BRAND.primaryColor.dark,
...
function WorkspaceTopBar({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_0%,color-mix(in_srgb,var(--primary)_20%,transparent),transparent_30%),radial-gradient(circle_at_78%_0%,rgba(34,211,238,0.13),transparent_26%),linear-gradient(90deg,rgba(255,255,255,0.05),transparent_34%,rgba(255,255,255,0.035))]" />
      <div className="relative flex min-w-0 flex-1 items-center gap-3">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-violet-200/25 bg-violet-100/[0.08] shadow-[0_0_24px_color-mix(in_srgb,var(--primary)_18%,transparent)]">
          <Image
            src={DEFAULT_BRAND.markSrc}
...
function WorkspaceResizeHandle({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'absolute left-1/2 top-1/2 h-10 w-px -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/60 opacity-0 shadow-[0_0_14px_color-mix(in_srgb,var(--primary)_28%,transparent)] transition-all',
