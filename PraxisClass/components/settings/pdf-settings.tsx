...
export function PDFSettings({ selectedProviderId }: PDFSettingsProps) {
  ...
  return (
    <div className="@container min-w-0 w-full max-w-3xl space-y-6">
      <ProviderScopeNote />
      ...
      {!isServerConfigured && needsRemoteConfig && (
        <>
          <div className="space-y-6">
            ...
            {/* API Key for self-hosted (optional, below the base URL) */}
            {isSelfHosted && (
              <div className="space-y-2">
                <Label className="text-sm">
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          {getFormatLabelsForProviders([selectedProviderId]).map((format) => (
            <Badge key={format} variant="secondary" className="px-2.5 py-1 font-normal">
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          {pdfProvider.features.map((feature) => (
            <Badge key={feature} variant="secondary" className="px-2.5 py-1 font-normal">
              <CheckCircle2 className="h-3 w-3 mr-1" />
