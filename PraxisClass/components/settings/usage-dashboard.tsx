...
export function UsageDashboard() {
  ...
  useEffect(() => {
    ...
    const axis = isDark ? '#b8c0cc' : '#505966';
    const split = isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.06)';
    const accent = isDark ? '#ffa18f' : '#c64f3c';
      ...
      series: [
        {
          ...
          areaStyle: {
            color: {
              ...
              y2: 1,
              colorStops: [
                { offset: 0, color: isDark ? 'rgba(255,161,143,0.28)' : 'rgba(198,79,60,0.18)' },
                { offset: 1, color: isDark ? 'rgba(255,161,143,0.02)' : 'rgba(198,79,60,0.02)' },
              ],
            },
          },
