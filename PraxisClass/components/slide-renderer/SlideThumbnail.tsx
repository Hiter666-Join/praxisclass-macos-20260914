...
import type { Slide, PPTImageElement, PPTVideoElement } from '@praxis/dsl';
import { SlideCanvas } from '@praxis/renderer';
...
/**
 * Read-only thumbnail rendering for a video element. Replaces `@praxis/renderer`'s
...
/**
 * Read-only slide thumbnail rendered via the extracted `@praxis/renderer`
 ...
 * is intentionally untouched (`@praxis/renderer` v1 is read-only; editing is v2).
 */
