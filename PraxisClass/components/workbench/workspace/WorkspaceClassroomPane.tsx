      ...
      {playback ? null : (
        ...
        >
          ...
          {onCollapse ? (
            <span className="mr-1 flex shrink-0 items-center">
              <PaneFoldButton
                ...
                direction="right"
                onClick={() => void saveBeforeLeaving(onCollapse)}
              />
            </span>
          ) : null}
          ...
          <WorkspaceCourseTabs
            ...
            onActivate={(id) => void saveBeforeLeaving(() => browser.onActivateCourse(id))}
            onClose={(id) => void saveBeforeLeaving(() => browser.onCloseCourse(id))}
          />
          ...
          <button
            ...
            onClick={() => void saveBeforeLeaving(() => setPlaybackOn(true))}
            className={cn(
