    ...
    <div data-testid="pro-launch-panel" className="flex w-full flex-col gap-3 text-left">
      ...
      <div
        ...
        className={cn(
          'relative',
          variant === 'workspace'
            ? 'ws-composer home-focus-input-card'
            : [
      ...
      >
        ...
        <ComposerTextarea
          ...
          className={cn(
            ...
            variant === 'workspace'
              ? cn('home-focus-textarea', hasComposerExtras && '!pt-2')
        ...
        <div
          className={cn(
            ...
            variant === 'workspace' ? 'ws-launch-actions home-focus-actions' : 'px-3 pb-3',
          )}
        >
          ...
          <ProLaunchSend
            canSend={canSend}
            onSubmit={submit}
            className={variant === 'workspace' ? 'home-focus-send' : undefined}
          />
        </div>
      </div>
    </div>
