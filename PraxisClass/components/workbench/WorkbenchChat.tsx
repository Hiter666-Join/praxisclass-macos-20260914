  ...
  const submit = useCallback(
    async (
      ...
      try {
        ...
        // special case.
        const messageText = withClassroomRuntimeErrors(text, navigation?.activeCourseId);
        const result = sessionId
          ? {
              accepted: true,
              ...(await postWorkbenchMessage(sessionId, messageText, attachments, refs, courses)),
            }
    ...
    [busy, draftConversation, sessionId, status, t, navigation?.activeCourseId],
  );
