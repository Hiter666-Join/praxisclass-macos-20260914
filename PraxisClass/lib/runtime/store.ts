...
/**
 * Lazy app-wide RuntimeStore singleton (#869). One `praxis-runtime` IndexedDB
 ...
 */
import { BrowserRuntimeStore, type RuntimeStore } from '@praxis/storage';
...
const RUNTIME_DB_NAME = 'praxis-runtime';
 ...
 * (`praxis-runtime`), so a broken or hung runtime DB must not brick stage
