...
import { generateXfyunTTS } from './xfyun-tts';
import {
...
export async function generateTTS(
  ...
  try {
    switch (config.providerId) {
      ...
      case 'xfyun-tts':
        return await generateXfyunTTS(config, text, signal);
      case 'elevenlabs-tts':
 ...
 *
 * PraxisClass keeps one internal VoxCPM request shape, then adapts it to the
