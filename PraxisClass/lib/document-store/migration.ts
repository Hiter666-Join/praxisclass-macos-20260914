import { DSL_VERSION, migrate } from '@praxis/dsl';
import { BrowserKVStore, type DocumentStore, type KVStore } from '@praxis/storage';
 ...
 * This mirrors `@praxis/storage`'s private `migrateDocument` in
