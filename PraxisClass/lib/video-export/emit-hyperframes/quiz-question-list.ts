...
export function quizQuestionListCss(width: number): string {
  ...
  return [
    `.quiz-question-list { padding:5.2%;background:linear-gradient(145deg,#071426 0%,#102a43 56%,#133f4b 100%);font-family:"PraxisClass Noto Sans Cyrillic","PraxisClass Noto Sans Arabic",Inter,"PraxisClass Noto Sans SC","PraxisClass Noto Sans KR",sans-serif; }`,
