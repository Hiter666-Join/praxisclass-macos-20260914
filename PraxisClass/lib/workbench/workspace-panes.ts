...
export const NAV_COLLAPSED_STORAGE_KEY = 'praxis:workspace:nav-collapsed';
export const CHAT_COLLAPSED_STORAGE_KEY = 'praxis:workspace:chat-collapsed';
export const CLASSROOM_COLLAPSED_STORAGE_KEY = 'praxis:workspace:classroom-collapsed';
export const CHAT_WIDTH_STORAGE_KEY = 'praxis:workspace:chat-width';
