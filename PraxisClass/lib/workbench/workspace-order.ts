...
/** localStorage keys. Same `praxis:workspace:` namespace as the rail width. */
export const COURSE_ORDER_STORAGE_KEY = 'praxis:workspace:course-order';
export const SESSION_ORDER_STORAGE_KEY = 'praxis:workspace:session-order';
