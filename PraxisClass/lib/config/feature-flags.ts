...
export function isAgentRuntimeEnabled(): boolean {
  return readBoolean(process.env.PRAXIS_AGENT_RUNTIME_ENABLED);
}
...
/**
 * PraxisClass Editor (Pro mode) gate. Default OFF — gates only the Pro toggle
 ...
 */
export function isPraxisEditorEnabled(): boolean {
  return isProWorkbenchEnabled() || readBoolean(process.env.NEXT_PUBLIC_PRAXIS_EDITOR_ENABLED);
}
...
export function isPlaybackRendererEnabled(): boolean {
  return readBoolean(process.env.NEXT_PUBLIC_PRAXIS_PLAYBACK_RENDERER_ENABLED);
}
...
export function isEditorRendererEnabled(): boolean {
  return readBoolean(process.env.NEXT_PUBLIC_PRAXIS_EDITOR_RENDERER_ENABLED);
}
...
export function isPiNativeChildRuntimeEnabled(): boolean {
  return readBoolean(process.env.PRAXIS_ENABLE_PI_NATIVE_CHILD_RUNTIME);
}
...
export function isPiNativeChildSpotlightEnabled(): boolean {
  return readBoolean(process.env.PRAXIS_ENABLE_PI_NATIVE_CHILD_SPOTLIGHT);
}
...
export function isVocationalTaskEngineEnabled(): boolean {
  return readBoolean(process.env.PRAXIS_ENABLE_VOCATIONAL);
}
