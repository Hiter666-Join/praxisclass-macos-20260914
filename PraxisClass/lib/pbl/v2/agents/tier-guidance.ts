...
const TIER_BLOCKS: Record<PBLProficiency, string> = {
  ...
  beginner: [
    ...
    'Keep every explanation and example within the learner\'s stated task context, and whenever you use a requirement knowledge point marked `来源：`, cite that source line verbatim.',
    '',
    COMMON_RULES,
  ].join('\n'),
  intermediate: [
