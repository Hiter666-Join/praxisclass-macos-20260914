 ...
 */
import { PgAssetByteStore } from '@praxis/storage/asset/pg-bytes';
import type { AssetByteStore, Queryable } from '@praxis/storage/asset/pg';
...
export async function createAssetByteStore(
  ...
  const storage = await import('@praxis/storage/asset/s3-bytes');
