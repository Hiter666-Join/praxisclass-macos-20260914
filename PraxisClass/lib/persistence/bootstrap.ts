import { BrowserKVStore, HttpDocumentStore, type HttpDocumentHeadersHook } from '@praxis/storage';
import { HttpRuntimeStore, type HttpRuntimeHeadersHook } from '@praxis/storage/runtime/http';
