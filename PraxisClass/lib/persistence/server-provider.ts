import { PgAssetStore, ensureAssetSchema } from '@praxis/storage/asset/pg';
import { PgDocumentStore, ensureDocumentSchema } from '@praxis/storage/document/pg';
import { PgRuntimeStore, ensureSchema } from '@praxis/storage/runtime/pg';
import {
  nodePostgresTransaction,
  type ConnectableQueryable,
} from '@praxis/storage/server/reference';
import { Pool } from 'pg';
