...
export const workbenchEn = {
  ...
  skill: {
    ...
    settings: {
      ...
      officialDownload: 'PraxisClass official skill',
    ...
    title: {
      'build-personal-skill': 'Teacher experience reuse',
...
export const workbenchZh = {
  ...
  skill: {
    ...
    settings: {
      ...
      uploadZip: '上传 zip 包',
      uploadFolder: '上传文件夹',
      officialDownload: 'PraxisClass官方skill',
      officialDownloadDesc:
