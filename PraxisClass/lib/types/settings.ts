...
/** Which platform surface the shell renders: teacher tools or student tools. */
export type PlatformMode = 'teacher' | 'student';

/**
 * Dify knowledge-base connection override. Blank fields fall back to the
