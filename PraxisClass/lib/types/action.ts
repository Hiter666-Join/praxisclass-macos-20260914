...
// presentation — now lives in `@praxis/dsl` and is re-exported below, so the
...
import type { SpeechAction as DslSpeechAction } from '@praxis/dsl';
...
export { FIRE_AND_FORGET_ACTIONS, SLIDE_ONLY_ACTIONS, SYNC_ACTIONS } from '@praxis/dsl';
