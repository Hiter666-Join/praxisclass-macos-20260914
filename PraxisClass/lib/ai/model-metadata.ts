...
const qwen38Budget = toggleBudgetCapability(
  'qwen',
  { min: 0, max: 262144, step: 1024, disableValue: 0 },
  true,
);
...
const THINKING_CAPABILITIES: Record<string, ThinkingCapability> = {
  [getModelMetadataKey('openai', 'gpt-6-astra')]: effortCapability(
    'openai',
  ...
  [getModelMetadataKey('anthropic', 'claude-fable-5-1')]: anthropicFable5Effort,
  ...
  [getModelMetadataKey('glm', 'glm-5.3')]: effortCapability('glm', ['low', 'high', 'max'], 'max'),
  ...
  [getModelMetadataKey('qwen', 'qwen3.8-max')]: qwen38Budget,
  [getModelMetadataKey('qwen', 'qwen3.8-flash')]: qwen38Budget,
  ...
  [getModelMetadataKey('xfyun-x2-flash', 'spark-x')]: {
    ...toggleCapability('xfyun'),
    control: 'mode',
  },
  [getModelMetadataKey('xfyun-x2', 'spark-x')]: {
    ...toggleCapability('xfyun'),
    control: 'mode',
  },
  [getModelMetadataKey('xfyun-x1-5', 'spark-x')]: fixedThinkingCapability,
