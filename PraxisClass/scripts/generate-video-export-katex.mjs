...
for (const [, body] of sourceCss.matchAll(/@font-face\{([^}]*)\}/g)) {
  ...
  faces.push(
    `@font-face{${declaration(/font-family:[^;]+/)};${declaration(/font-style:[^;]+/)};${declaration(/font-weight:[^;]+/)};font-display:block;src:url("__PRAXIS_QUIZ_FONT_BASE__/${filename}") format("woff2")}`,
  );
  assets.push({
