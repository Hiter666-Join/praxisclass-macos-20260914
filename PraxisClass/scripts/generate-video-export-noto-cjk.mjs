...
const faces = [
  {
    ...
    family: 'PraxisClass Noto Sans SC',
  ...
  },
  {
    ...
    subset: 'korean',
    family: 'PraxisClass Noto Sans KR',
...
for (const face of faces) {
  ...
  css.push(
    `@font-face{font-family:"${face.family}";font-style:normal;font-weight:400;font-display:block;src:url("__PRAXIS_QUIZ_FONT_BASE__/${face.filename}") format("woff2")}`,
  );
  assets.push({
