...
const cssFor = (face) =>
  `@font-face{font-family:"${face.family}";font-style:normal;font-weight:400;font-display:block;src:url("__PRAXIS_QUIZ_FONT_BASE__/${face.filename}") format("woff2");unicode-range:${face.unicodeRange}}`;
