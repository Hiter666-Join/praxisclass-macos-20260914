...
import { BrowserRuntimeStore, type PraxisDocument, type RuntimeStore } from '@praxis/storage';
...
function document(whiteboard?: Whiteboard[]): PraxisDocument<AppScene, AppStage> {
  return {
    stage: {
      id: 'stage-1',
      name: 'Stage',
