...
import type { Action } from '@praxis/dsl';
import {
...
describe('Quiz question-list Hyperframes emission', () => {
  ...
  it('renders escaped static questions with shared math parsing and no learner controls/state', () => {
    ...
    expect(html).toContain(
      'font-family:"PraxisClass Noto Sans Cyrillic","PraxisClass Noto Sans Arabic",Inter,"PraxisClass Noto Sans SC","PraxisClass Noto Sans KR",sans-serif',
    );
  });
