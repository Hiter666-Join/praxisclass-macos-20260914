 ...
 * `@praxis` package directories excluded from the dynamic-import ban, and both
...
const GUARDED_PATHS = [
  ...
  'app/api/probe/route',
  'components/probe',
  'packages/@praxis/renderer/src/probe',
  'packages/@praxis/storage/src/probe',
  'packages/@praxis/generation/src/probe',
...
describe('LLM entry-point lint guard — coverage matrix', () => {
  ...
  it('still enforces the pre-existing module boundaries it shares a rule key with', async () => {
    ...
    for (const filePath of [
      'packages/@praxis/renderer/src/probe.ts',
      'packages/@praxis/storage/src/probe.ts',
      'packages/@praxis/generation/src/probe.ts',
